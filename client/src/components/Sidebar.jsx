...
export default function Navbar() {
	...
	return (
		<aside className="w-64 bg-gray-50 dark:bg-gray-800 p-4 space-y-4">
			{/* {Logo} */}
			<div className="hidden lg:flex w-1/2 items-center justify-center p-3">
				<motion.div
				...
				>
					...
					<h2 className="text-xl font-bold uppercase text-primary-300">
						Kanban
					</h2>
				</motion.div>
			</div>
